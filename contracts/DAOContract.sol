...
contract MyContract is ERC721URIStorage {
  //Transfer NFT
  //A verificação de votos deve ser feita pelo código do nft e não pelo endereço que o possui
  address owner;
  ...
  struct Proposal {
      uint256 proposalId;
      string description;
      address[] yesVotes; //Trocar para array de endereços, validações devem buscar pelo endereço nos dois votos para não votar novamente.
      address[] noVotes;
      bool isOpen;
